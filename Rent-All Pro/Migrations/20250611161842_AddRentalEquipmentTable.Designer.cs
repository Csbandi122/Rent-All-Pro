...
namespace Rent_All_Pro.Migrations
{
    ...
    [Migration("20250611161842_AddRentalEquipmentTable")]
    partial class AddRentalEquipmentTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentAllPro.Models.RentalEquipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RentAllPro.Models.RentalEquipment", b =>
                {
                    b.HasOne("RentAllPro.Models.Equipment", "Equipment")
                        .WithMany()
                        .HasForeignKey("EquipmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RentAllPro.Models.Rental", "Rental")
                        .WithMany()
